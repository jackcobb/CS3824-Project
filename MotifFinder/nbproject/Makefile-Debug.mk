...
${OBJECTDIR}/MotifHashTable.o: MotifHashTable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotifHashTable.o MotifHashTable.cpp
...
${OBJECTDIR}/RandomProjectionSearchEngine.o: RandomProjectionSearchEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomProjectionSearchEngine.o RandomProjectionSearchEngine.cpp
